...
#	Renamed function from topology_sort2 to topology_sort.
#	Handle empty input.
...
__all__ = ['topology_sort', 'topology_sort_flatten']
...
def topology_sort_flatten(data, sort=True):
	"""Returns a single list of dependencies. For any set returned by
topology_sort(), those items are sorted and appended to the result (just to
make the results deterministic)."""

	result = []
	for d in topology_sort(data):
